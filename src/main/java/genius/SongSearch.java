...
public class SongSearch {
    ...
    public class Hit {
        ...
        public Hit(JSONObject jRoot) {
           ...
           // this.date = new Date(jRoot.getJSONObject("release_date_components"));
            this.release_date_for_display =  jRoot.getString("release_date_for_display");
    ...
    public class Date {
        ...
        public Date(JSONObject jRoot) {

            this.year = jRoot.getString("year");
            this.month = jRoot.getString("month");
            this.day = jRoot.getString("day");
